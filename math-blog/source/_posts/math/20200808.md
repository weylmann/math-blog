...
![图片挂了, 刷新一下呗](http://weylmann.cn/img/20200808p1.png  "奇怪的知识增加了")
...
![图片挂了, 刷新一下呗](http://weylmann.cn/img/20200808s2.png  "奇怪的知识增加了")
...
思路二: 设$M$ 为$BC$ 中点, 连结$AM$ 交$BE$ 于点$N$, 做$MF\parallel BE$ 交$AC$ 于$F$.
 ...
 ![图片挂了, 刷新一下呗](http://weylmann.cn/img/20200808s1.png  "奇怪的知识增加了")
