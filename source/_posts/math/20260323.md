...
<strong>答案：</strong>最大值为 $2\sqrt{5}$，最小值为 $4$。

<strong>【点评】</strong>本题的关键在于利用模长平方展开后应用均值不等式。注意到 $(5+4\cos\theta)(5-4\cos\theta)=25-16\cos^{2}\theta$，其最大值出现在 $\cos\theta=0$ 时。另外，两向量同向或反向时取得最小值，这体现了三角不等式的核心思想。
