...
设 $z_1 = r_1(\cos\alpha + i\sin\alpha)$，$z_2 = r_2(\cos\beta + i\sin\beta)$，$z_3 = r_3(\cos\gamma + i\sin\gamma)$，$z_4 = r_4(\cos\eta + i\sin\eta)$，

由 $|z_1|^2 + |z_2|^2 = |z_3|^2 + |z_4|^2 = 4$ 可得 $r_1^2 + r_2^2 = r_3^2 + r_4^2 = 4$。
